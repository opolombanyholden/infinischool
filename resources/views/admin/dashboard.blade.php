                ...
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between text-muted small">
                            ...
                            <span><i class="fas fa-chalkboard-teacher me-1"></i>{{ $stats['teachers'] ?? 0 }}
                                formateurs</span>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('admin.formations.index') }}">Voir
                                            toutes</a></li>
                                    <li><a class="dropdown-item" href="{{ route('admin.formations.pending') }}">En
                                            attente</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between text-muted small">
                            <span class="text-success"><i
                                    class="fas fa-check-circle me-1"></i>{{ $stats['published_formations'] ?? 0 }}
                                publiées</span>
                            <span class="text-warning"><i
                                    class="fas fa-clock me-1"></i>{{ $stats['pending_formations'] ?? 0 }} en attente</span>
                        </div>
                        <div class="mt-3 pt-2 border-top">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('admin.reports.revenue') }}">Rapport</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="progress mb-2" style="height: 8px;">
                            <div class="progress-bar bg-success" role="progressbar"
                                style="width: {{ ($stats['revenue_progress'] ?? 65) }}%"></div>
                        </div>
                        <div class="d-flex justify-content-between text-muted small">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('admin.reviews.index') }}">Tous les avis</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{ route('admin.reviews.flagged') }}">Signalés</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            @for($i = 1; $i <= 5; $i++)
                                <i
                                    class="fas fa-star {{ $i <= ($stats['platform_rating'] ?? 0) ? 'text-warning' : 'text-muted opacity-25' }} small"></i>
                            @endfor
                        </div>
                        <div class="d-flex justify-content-between text-muted small">
                                ...
                                <tbody>
                                    @forelse($recentActivities ?? [] as $activity)
                                        <tr>
                                            <td>
                                                <span
                                                    class="badge bg-{{ $activity->type === 'enrollment' ? 'primary' : ($activity->type === 'payment' ? 'success' : 'info') }}-subtle 
                                                             text-{{ $activity->type === 'enrollment' ? 'primary' : ($activity->type === 'payment' ? 'success' : 'info') }}">
                                                    <i
                                                        class="fas fa-{{ $activity->type === 'enrollment' ? 'user-plus' : ($activity->type === 'payment' ? 'dollar-sign' : 'info-circle') }} me-1"></i>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="fw-semibold small">
                                                            {{ $activity->user->full_name ?? 'Utilisateur' }}</div>
                                    ...
                                    <div class="card border h-100">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                ...
                                                <span class="badge bg-primary">{{ $formation->enrollments_count ?? 0 }}
                                                    inscrits</span>
                                            </div>
                                            <p class="text-muted small mb-2">Par
                                                {{ $formation->teacher->full_name ?? 'Enseignant' }}</p>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    <i class="fas fa-star text-warning me-1"></i>
                                                    <span
                                                        class="fw-semibold">{{ number_format($formation->average_rating ?? 0, 1) }}</span>
                                                    <small class="text-muted">({{ $formation->reviews_count ?? 0 }})</small>
                                                </div>
                                                <span
                                                    class="text-success fw-semibold">{{ number_format($formation->revenue ?? 0, 0, ',', ' ') }}
                                                    FCFA</span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-3">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('admin.formations.pending') }}"
                                class="btn btn-outline-warning text-start position-relative">
                            ...
                            <a href="{{ route('admin.support.index') }}"
                                class="btn btn-outline-secondary text-start position-relative">
                            ...
                            <a href="{{ route('admin.settings.index') }}" class="btn btn-outline-secondary text-start">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div>
                                    <span class="text-muted small me-2">{{ $system['storage_used'] ?? 0 }}GB /
                                        {{ $system['storage_total'] ?? 100 }}GB</span>
                                    <span
                                        class="badge bg-{{ ($system['storage_percentage'] ?? 0) > 80 ? 'danger' : 'success' }}-subtle 
                            ...
                            <div class="progress" style="height: 6px;">
                                <div class="progress-bar bg-{{ ($system['storage_percentage'] ?? 0) > 80 ? 'danger' : 'success' }}"
                                    role="progressbar" style="width: {{ $system['storage_percentage'] ?? 0 }}%">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        @forelse($pendingRequests ?? [] as $request)
                            <div class="d-flex align-items-start mb-3 pb-3 border-bottom">
                                <div class="me-3">
                                    <div
                                        class="rounded-circle bg-{{ $request->type === 'approval' ? 'warning' : 'info' }} bg-opacity-10 p-2">
                        ...
                        @forelse($systemAlerts ?? [] as $alert)
                            <div class="alert alert-{{ $alert->level ?? 'info' }} border-0 mb-2" role="alert">
                                <div class="d-flex align-items-start">
                                    <i
                                        class="fas fa-{{ $alert->level === 'danger' ? 'exclamation-triangle' : 'info-circle' }} me-2 mt-1"></i>
                                    <div class="flex-grow-1">
