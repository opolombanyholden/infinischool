                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <select class="form-select @error('country') is-invalid @enderror" id="country"
                                                ...
                                                <option value="GA"
                                                    {{ old('country', $user->country) === 'GA' ? 'selected' : '' }}>Gabon
                                                </option>
                                                <option value="FR"
                                                    {{ old('country', $user->country) === 'FR' ? 'selected' : '' }}>France
                                                </option>
                                                <option value="CI"
                                                    {{ old('country', $user->country) === 'CI' ? 'selected' : '' }}>Côte
                                                    d'Ivoire</option>
                                                <option value="SN"
                                                    {{ old('country', $user->country) === 'SN' ? 'selected' : '' }}>Sénégal
                                                </option>
                                                <option value="CM"
                                                    {{ old('country', $user->country) === 'CM' ? 'selected' : '' }}>Cameroun
                                                </option>
                                ...
                                <form action="{{ route('profile.password.update') }}" method="POST" id="passwordForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <small class="text-muted" id="passwordStrengthText">Force du mot de
                                                passe</small>
                                        </div>
                                    </div>
                                ...
                                <form action="{{ route('profile.preferences.update') }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="notify_new_course"
                                            ...
                                            <label class="form-check-label" for="notify_new_course">
                                                ...
                                                <br><small class="text-muted">Recevoir des alertes quand de nouveaux cours
                                                    sont publiés</small>
                                            </label>
                                        </div>

                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="notify_class_reminder"
                                            ...
                                            <label class="form-check-label" for="notify_class_reminder">
                                                ...
                                                <br><small class="text-muted">Recevoir un rappel 1h avant chaque cours en
                                                    direct</small>
                                            </label>
                                        </div>

                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="notify_certificate"
                                        ...
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="notify_messages"
                                            ...
                                            <label class="form-check-label" for="notify_messages">
                                                ...
                                                <br><small class="text-muted">Recevoir une notification pour les nouveaux
                                                    messages</small>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="notify_newsletter">
                                                ...
                                                <br><small class="text-muted">Recevoir nos actualités et offres
                                                    spéciales</small>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" name="language" style="max-width: 300px;">
                                            <option value="fr"
                                                {{ old('language', $user->preferences->language ?? 'fr') === 'fr' ? 'selected' : '' }}>
                                                Français</option>
                                            <option value="en"
                                                {{ old('language', $user->preferences->language ?? 'fr') === 'en' ? 'selected' : '' }}>
                                                English</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" name="timezone" style="max-width: 300px;">
                                            <option value="Africa/Libreville"
                                                {{ old('timezone', $user->preferences->timezone ?? 'Africa/Libreville') === 'Africa/Libreville' ? 'selected' : '' }}>
                                                Libreville (WAT)
                                            </option>
                                            <option value="Europe/Paris"
                                                {{ old('timezone', $user->preferences->timezone ?? 'Africa/Libreville') === 'Europe/Paris' ? 'selected' : '' }}>
                                                Paris (CET)
                                            </option>
                                        </select>
                                    </div>
                    ...
                    <div class="card-body text-center">
                        <div class="position-relative d-inline-block mb-3">
                            <img src="{{ $user->avatar ? Storage::url($user->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($user->full_name) . '&size=150&background=800020&color=fff' }}"
                                alt="Photo de profil" class="rounded-circle" id="avatarPreview"
                            ...
                            <button type="button"
                                ...
                                style="width: 40px; height: 40px;" onclick="document.getElementById('avatarInput').click()">
                        ...
                        <span class="badge bg-primary-subtle text-primary">
                            <i
                                class="fas fa-{{ $user->role === 'student' ? 'graduation-cap' : ($user->role === 'teacher' ? 'chalkboard-teacher' : 'shield-alt') }} me-1"></i>
                            {{ ucfirst($user->role) }}
                        </span>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span
                                class="fw-semibold">{{ $user->last_login_at?->locale('fr')->diffForHumans() ?? 'Jamais' }}</span>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Êtes-vous sûr de vouloir supprimer votre compte ? Toutes vos données seront définitivement effacées :
                    </p>
                    <ul>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="bg-light p-3 rounded mb-3">
                        <img src="https://via.placeholder.com/200x200/800020/ffffff?text=QR+CODE" alt="QR Code 2FA"
                            class="img-fluid">
                    </div>
                    ...
                    <form action="{{ route('profile.2fa.enable') }}" method="POST">
                        @csrf
                        <input type="text" class="form-control text-center mb-3" name="code" placeholder="Code à 6 chiffres"
