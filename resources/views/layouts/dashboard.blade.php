...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body
        class="{{ request()->routeIs('admin.*') ? 'admin-space' : (request()->routeIs('teacher.*') ? 'teacher-space' : 'student-space') }}">
            ...
            <div class="dashboard-topbar">
                ...
                <div class="topbar-right">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        ...
                        <li><a class="dropdown-item" href="{{ route('notifications.index') }}">Voir toutes les
                                notifications</a></li>
                    </ul>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow">
                            ...
                            <li><a class="dropdown-item" href="{{ route('home') }}"><i
                                        class="fas fa-home me-2"></i>Retour à l'accueil</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li>
